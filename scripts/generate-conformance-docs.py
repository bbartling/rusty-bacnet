...
def pics_draft(data: dict) -> str:
    rows = data["rows"]
    data_links = [r for r in rows if r["standard_anchor"] in {"Annex J.2", "Annex J", "Annex J.4/J.5", "Annex J.5", "Annex U", "Clause 7", "Clause 9.3", "Annex AB.2", "Annex AB.5", "Annex AB.7", "Annex AB.6.3"}]
