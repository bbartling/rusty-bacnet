...
| `BACNET-AB-SC-HUB-CONNECTOR` | Annex AB.5 | implementation-present-needs-conformance-tests | `crates/bacnet-transport/src/sc/failover.rs`, `crates/bacnet-transport/src/sc/mod.rs`, `crates/bacnet-transport/src/sc/handshake.rs`, `crates/bacnet-transport/src/sc_hub.rs`, `crates/bacnet-transport/src/sc_hub/relay.rs` |
