...
| `BACNET-AB-SC-BVLC-RESULT` | Annex AB.2.4 | implementation-present-needs-conformance-tests | `crates/bacnet-transport/src/sc_frame.rs`, `crates/bacnet-transport/src/sc/mod.rs`, `crates/bacnet-wasm/src/sc_frame.rs`, `crates/bacnet-wasm/src/sc_connection.rs` |
