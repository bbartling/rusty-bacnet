...
- Current scope: Annex J Read-BDT-Ack and Read-FDT-Ack malformed management ACK payload validation evidence.
- Addenda/errata status: Local source `_spec/2020_ASHRAE_Standard-135-BACnet-Data-Communication-Protocol.pdf` checked on 2026-06-28 for Annex J.2.4 Read-Broadcast-Distribution-Table-Ack N*10 BDT entry format, Annex J.4.4.1 BBMD Read-BDT behavior, Annex J.2.8 Read-Foreign-Device-Table-Ack N*10 FDT entry format, and Annex J.5.2.1.1 BBMD Read-FDT behavior; no separate addenda/errata source is committed for this tranche.
