...
- Current scope: Annex AB.3.4 BACnet/SC Data Options data_attributes plumbing and Annex AB.3.1.4/AB.3.4 native unsupported Must Understand Data Option receive policy, including native SC transport ReceivedNpdu preservation, NetworkLayer ReceivedApdu exposure, outbound DataAttribute-to-Data-Options send helpers at TransportPort and NetworkLayer, router local-delivery and router forwarding preservation, non-SC empty/ignore behavior, and native fail-closed handling for unsupported Must Understand Data Options.
