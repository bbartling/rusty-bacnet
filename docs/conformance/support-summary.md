...
- Implementation evidence SHA reviewed: `2d2b3bc0ba4514ff48f806e5910b522f875b3f8c`
- Scope: Annex AB.6.2 BACnet/SC initiating-peer duplicate VMAC recovery and Clause H.7.3 Random-48 VMAC generation, including native Connect-Request BVLC-Result NAK handling, initial failover retry payloads, native connect-time/I/O cleanup, WASM/browser VMAC generation and retry state, and generic Connect-Request NAK fail-closed behavior.
